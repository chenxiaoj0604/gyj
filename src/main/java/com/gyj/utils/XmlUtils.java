...
import com.gyj.domain.MessageHeader;
import com.gyj.domain.ResultVO;
...
public class XmlUtils {
    ...
    public static String printErrorXml() throws JAXBException{
        ResultVO resultVO = new ResultVO();
        resultVO.setMessageHeader(MessageHeader.fail());
        return object2XmlStr(resultVO);
    }

    public static String printErrorXml(String errorMsg) throws JAXBException{
        ResultVO resultVO = new ResultVO();
        resultVO.setMessageHeader(MessageHeader.fail(errorMsg));
        return object2XmlStr(resultVO);
    }
